<template>
    <div class="space-y-6">
        ...
        <div class="bg-bg-card p-4 rounded-card shadow-sm border border-border">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input id="search" v-model="filters.search" @input="applyFilters" type="text"
        ...
        <!-- Loading State -->
        <div v-if="notifStore.loadingStates.admin" class="flex justify-center py-8">
        ...
        <div v-else class="bg-bg-card shadow-sm rounded-card border border-border">
            ...
            <ul v-else class="divide-y divide-border">
                <li v-for="task in adminStore.allTasks" :key="task.id"
